...
module.exports = {
  ...
  getGeoIp (req) {
    ...
    if (!geo && ip && (ip === '192.168.254.0' || ip === '192.168.254.193' || ip === '192.168.254.145' || ip === '192.168.254.163' || ip === '192.168.254.169' || ip === '192.168.254.118' || ip === '217.117.31.15' || ip === '192.168.51.1' || ip === '193.41.197.4' || ip === '193.41.197.160' || ip === '193.41.197.201' || ip === '192.168.19.112' || ip === '192.168.19.151' || ip === '192.168.19.85' || ip === '193.41.197.160')) {
      return {
        ip: ip,
        country: 'ADMIN'
      }
